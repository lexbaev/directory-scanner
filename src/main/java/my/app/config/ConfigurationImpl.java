...
public class ConfigurationImpl implements Configuration {
  ...
  public Map<String, Class> initMenuMap() {
    ...
    try {
      ...
      logger.error("The properties file is not found or invalid. " + e.getMessage());
      System.exit(1);
    }
    ...
    for (String key : config.stringPropertyNames()) {
      try {
        ...
        logger.error("The class " + config.getProperty(key) + "from configuration properties is not found. " + e.getMessage());
        System.exit(1);
      }
    }
